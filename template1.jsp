...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .item-subtitle { font-weight: 600; color: #3498db; margin-bottom: 5px; }
        ...
        @media print {
            ...
            .resume-card { box-shadow: none; margin: 0; border-radius: 0; }
        }
    </style>
...
<div class="resume-card">
    ...
    <div class="resume-body">
        ...
        <div class="section">
            <div class="section-title"><i class="fas fa-user-edit"></i> Professional Summary</div>
        ...
        <div class="two-column">
            <div class="left-col">
                ...
                <div class="section">
                    ...
                    <div class="item-desc"><%= education.replace("\n", "<br>") %></div>
                </div>
                <% } %>
                ...
                <div class="section">
                    ...
                    <div class="item-desc"><%= experience.replace("\n", "<br>") %></div>
                </div>
                <% } %>
                ...
                <div class="section">
                    ...
                    <% for(int i = 0; i < projects.length(); i++) {
                        ...
                        <div class="mb-3">
                            ...
                            <div class="item-desc"><%= desc.replace("\n", "<br>") %></div>
                        </div>
                    <% } } %>
                </div>
                <% } %>
            ...
            <div class="right-col">
                ...
                <div class="section">
                    ...
                    <div class="skills-grid">
                        <span class="skill-badge"><%= languages %></span>
                    </div>
                </div>
                <% } %>
                ...
                <div class="section">
                    <div class="section-title"><i class="fas fa-address-card"></i> References</div>
                    <div class="item-desc"><%= references.replace("\n", "<br>") %></div>
                </div>
                <% } %>
            </div>
        </div>
